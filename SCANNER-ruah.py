...
# Se eliminó la pregunta sobre categorías y la variable kanall
...
def onay(veri,user,pas):
		...
		# Se eliminó la sección de categorías
...
╰─    """)
		# Se eliminó la variable imzak (categorías)
		mtl=("""
╭─➤🄼➂🅄 
├  """+m3ulink+""" """)
...
"""
		# Escribir en archivo sin categorías
		yaz(mt+sayi+mtl+whatsapp+'\n')
		# Mostrar en pantalla sin categorías
		print(mt+sayi+mtl+whatsapp)
